...
#
# File: components/time-spent/time-spent.directive.coffee
###
...
timeSpentDirective = () ->
    ...
    return {
        ...
        controllerAs: "vm"
        templateUrl: 'components/time-spent/time-spent.html'
...
# timeSpentDirective = ($rootscope, $confirm, $repo, $modelTransform, $template,
...
module.directive('tgTimeSpent', timeSpentDirective)
